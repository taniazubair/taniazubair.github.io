...
| Page | Content |
|------|---------|
| **Home** | Hero section with draggable ID card, about section, work experience cards (HT-Networks and STEP Schools), and a skills toolkit with 14 glowing tech chips |
| **Work** | 3D interactive project stack, detailed project breakdowns, and a competitions section featuring IEEE OOP and DLD Traffic Control |
| **Contact** | Contact form, email/phone/GitHub/location cards, social links, and an availability badge |
...
|---------|------|-------------|
| **Car Rental System** | C++, OOP | Console-based application managing vehicle rentals, customer records, and booking workflows using advanced object-oriented programming |
| **Quiz Conduct System** | C++, OOP | Automated quiz platform handling student participation, real-time scoring, and result analytics with robust validation |
| **Bakery Website** | HTML, CSS | Team project building a fully responsive bakery website with product galleries and smooth animations. [Live demo here](https://wasiahmed02.github.io/Bakery-Website--ICT-Project-/) |
| **DLD Traffic Control** | Logic Gates, Flip-Flops | Two-road traffic control system built purely with Digital Logic Design components — no code, just hardware logic for real-time signal management |
...
- **Email:** tzak2004@gmail.com
- **Phone:** +92 334 3330648
- **GitHub:** [github.com/taniazubair](https://github.com/taniazubair)
- **Location:** Islamabad, Pakistan

---

Built with care by Tania Zubair.
